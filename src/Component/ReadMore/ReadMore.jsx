            ...
            <a className="relative" >
              <div className="relative w-full aspect-video">
                <img
                  ...
                  src="https://i.ibb.co/0tghrKD/photo-1535469163135-61bb3e79b672.jpg"
                  alt="Writey A.I"
                  loading="lazy"
                />
          ...
          <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
            <a className="relative" >
              <div className="relative w-full aspect-video">
                <img
                  className="rounded w-full h-full object-cover"
                  src="https://i.ibb.co/y46cNZY/photo-1647228966883-a8605dd7f88a.jpg"
                  alt="WriteMe.ai"
                  loading="lazy"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
          ...
          <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
            <a className="relative" >
              <div className="relative w-full aspect-video">
                <img
                  className="rounded w-full h-full object-cover"
                  src="https://i.ibb.co/brMmXZ0/photo-1623237801985-0e168cfb0e3d.jpg"
                  alt="Publer"
                  loading="lazy"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
          ...
          <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
            <a className="relative" >
              <div className="relative w-full aspect-video">
                <img
                  className="rounded w-full h-full object-cover"
                  src="https://i.ibb.co/syCxQ3T/motion-array-1271460-DJI-0970-V1-0150-high-0013.jpg"
                  alt="Anyword"
                  loading="lazy"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
          ...
          <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
            <a className="relative" >
              <div className="relative w-full aspect-video">
                <img
                  className="rounded w-full h-full object-cover"
                  src="https://i.ibb.co/s1tXyLS/photo-1661505084016-7655251f70b5.jpg"
                  alt="BlogSEO AI"
                  loading="lazy"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
                  ...
                  <p className="font-medium text-sm">
                    AI Writer for SEO&zwj; That Follows Best Practices
                  </p>
                </div>
              </div>
            </a>
          ...
          <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
            <a className="relative" >
              <div className="relative w-full aspect-video">
                <img
                  className="rounded w-full h-full object-cover"
                  src="https://i.ibb.co/rbQg5kQ/photo-1611222566360-ef1f0a8c6451.jpg"
                  alt="Typewise"
                  loading="lazy"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-gray-800 to-gray-500 text-white">
